...
mod tests {
    ...
    async fn signup_forwards_to_users() {
        ...
        let app = user_routes(spy.clone(), SessionsDummy);
    ...
    async fn login_in_route_forwards_to_users() {
        ...
        let app = user_routes(UsersStub, SessionsDummy);
    ...
    async fn login_sets_session_cookie() {
        ...
        let app = user_routes(UserDummy, SessionsStub);
    ...
    async fn logout_clears_session_cookie() {
        // Given
        let app = user_routes(UserDummy, SessionsDummy);
    ...
    async fn logout_destroys_session() {
        ...
        let app = user_routes(UserDummy, spy.clone());
    ...
    async fn wrong_credentials_returns_401() {
        ...
        let app = user_routes(UsersSaboteur, Dummy);
    ...
    async fn user_info() {
        ...
        let app = user_routes(UsersStub, Dummy);
